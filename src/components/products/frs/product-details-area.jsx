                            ...
                            <div className="col-lg-6 col-md-6">
                                <div className="product mb-40 ml-20 wow fadeInRighRight" data-wow-delay=".4s">
                                    <div className="product__details-content mb-40">
                                        ...
                                        <ul>
                                            <li style={{ marginBottom: '20px' }}>Excitingly, Cygnus Payments Solutions proudly announces a strategic partnership with FRS. As leaders in loss remediation, this collaboration enhances our capabilities and ensures a comprehensive approach to financial recovery. Together with FRS, Cygnus Payments Solutions is committed to providing unparalleled solutions in the payment industry.</li>
                                            <li style={{ marginBottom: '20px' }}>Discover Financial Recovery Services (FRS), the trusted ally in loss remediation across diverse industries. FRS excels in servicing key market segments, including BankCard, Retail, Installment Loan, Service Contracts, and Utilities. With a proven track record in placement levels ranging from Early-Out to Warehouse, FRS sets itself apart in the collection industry. Embracing cutting-edge technologies like EDI and automated processing, Financial Recovery Services effortlessly accommodates individual client placement volumes. What makes us unique is our ability to manage this diverse array of services equally, thanks to the breadth and experience of our most valuable resource - our people, collectively bringing centuries of expertise to the table. Here's an exclusive opportunity: if you accepted payments between January 1, 2004, and January 25th, 2019, seize the six-month window to sign up and participate in the settlement process.</li>
                                        </ul>
                                        <div className="pro-quan-area d-sm-flex align-items-center mb-15"></div>
                                        <div className="product-button">
                                            <a href="https://www.frsco.com/cygnus/" target="_blank" rel="noopener noreferrer">
