                            ...
                            <div className="col-lg-6 col-md-6">
                                ...
                                >
                                    <div className="product__details-content mb-40">
                                        ...
                                        <p>
                                            Change the way your point of sales
                                            terminal provides services to the
                                            customers of your store! With
                                            powerful retail technology at the
                                            core of our system, revolutionize
                                            the way your store functions!
                                            User-friendly touch screen displays
                                            now fully-integrated into the JMSC
                                            POS® System helps increase
                                            competitive edge, reduce inventory
                                            delays, improve sales, maximize
                                            productivity, and enhance the
                                            customers’ experience across all
