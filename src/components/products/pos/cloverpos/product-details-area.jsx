                    ...
                    <div className="shop-left-right ml-130 mr-130">
                        <div className="row">
                            <div className="col-lg-6 col-md-6">
                                ...
                                >
                                    <img
                                        src="/assets/img/shop/pos/clover.png"
                                        alt="product-thumb"
                                    />
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-6">
                                ...
                                >
                                    <div className="product__details-content mb-40">
                                        ...
                                        <p>
                                            Accept payments and run your
                                            business with a flexible
                                            point-of-sale system that works as
                                            hard as you do. Station Solo
                                            supports your operations and
                                            management and gives you more time
                                            to focus on the reason you’re in
                                            business.
                                        </p>
