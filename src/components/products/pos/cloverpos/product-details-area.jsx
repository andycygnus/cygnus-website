              ...
              <div className="col-lg-6 col-md-6">
                ...
                >
                  <div className="product__details-content mb-40">
                    <h5 className="product-dtitle mb-20">Clover POS</h5>
                    <p>
                    Accept payments and run your business with a flexible point-of-sale system
                     that works as hard as you do. Station Solo supports your operations and management 
                     and gives you more time to focus on the reason you’re in business.
                    </p>
                    ...
                    <div className="product-button">
                      <a href="https://jmscpos.com/" target="_blank" rel="noopener noreferrer">
                        <button className="tp-btn mr-20">Visit Clover</button>
                      </a>
                    </div>
                  </div>
                </div>
