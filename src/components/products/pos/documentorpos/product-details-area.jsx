                    ...
                    <div className="shop-left-right ml-130 mr-130">
                        <div className="row">
                            <div className="col-lg-6 col-md-6">
                                ...
                                >
                                    <img
                                        src="/assets/img/shop/pos/documentor.png"
                                        alt="product-thumb"
                                    />
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-6">
                                ...
                                >
                                    <div className="product__details-content mb-40">
                                        ...
                                        <p>
                                            We support a variety of registers
                                            with both front and rear graphical
                                            displays. The customer display can
                                            be used, by time,
                                            <br /> to display weekly specials.
                                            We support up to two drive-thru's
                                            with an order and recall register
                                            and bagging monitors.
                                        </p>
                                        <div className="pro-quan-area d-sm-flex align-items-center mb-15"></div>
                                        <div className="product-button">
                                            <a
                                                href="https://documentorpos.com/"
                                                target="_blank"
