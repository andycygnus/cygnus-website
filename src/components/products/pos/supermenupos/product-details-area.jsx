          ...
          <div className="shop-left-right ml-130 mr-130">
            <div className="row">
              <div className="col-lg-6 col-md-6">
                ...
                >
                  <img
                    src="/assets/img/shop/pos/supermenu.png"
                    alt="product-thumb"
                  />
                </div>
              </div>
              <div className="col-lg-6 col-md-6">
                ...
                >
                  <div className="product__details-content mb-40">
                    <h5 className="product-dtitle mb-20">Supermenu POS</h5>
                    <p>
                        We offer the easiest Point of Sale (POS) software to help restaurants with 
                        the tools they need to easily and seamlessly take orders and process payments in 
                        their places of business. Our software is time-tested with virtually all the important 
                        features needed for all kinds of restaurants to successfully run their business on the daily basis.
                    </p>
                    <div className="pro-quan-area d-sm-flex align-items-center mb-15">
                    </div>
                    <div className="product-button">
                      <a href="https://supermenupos.com/" target="_blank" rel="noopener noreferrer">
                        <button className="tp-btn mr-20">Visit Supermenu</button>
                      </a>
                    </div>
                  </div>
                </div>
