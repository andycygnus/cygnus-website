                    ...
                    <div className="shop-left-right ml-130 mr-130">
                        <div className="row">
                            <div className="col-lg-6 col-md-6">
                                ...
                                >
                                    <img
                                        src="/assets/img/shop/online-ordering.png"
                                        alt="product-thumb"
                                    />
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-6">
                                ...
                                >
                                    <div className="product__details-content mb-40">
                                        ...
                                        <p>
                                            We have a solution for all of your
                                            Point of Sale needs from super fast
                                            quick service solutions to online
                                            and mobile ordering apps.
                                        </p>
                                        <div className="pro-quan-area d-sm-flex align-items-center mb-15"></div>
                                        <div className="product-button">
                                            <a
                                                href="https://demo.maiorders.com/#/"
                                                target="_blank"
