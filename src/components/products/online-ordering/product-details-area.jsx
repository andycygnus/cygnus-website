              ...
              <div className="col-lg-6 col-md-6">
                ...
                >
                  <div className="product__details-content mb-40">
                    <h5 className="product-dtitle mb-20">Online Ordering</h5>
                    <p>
                      We have a solution for all of your Point of Sale needs from super fast quick service solutions
                      to online and mobile ordering apps.
                    </p>
                    <div className="pro-quan-area d-sm-flex align-items-center mb-15">
                    </div>
                    <div className="product-button">
                      <a href="https://demo.maiorders.com/#/" target="_blank" rel="noopener noreferrer">
                        <button className="tp-btn mr-20">View Demo</button>
                      </a>
                    </div>
                  </div>
                </div>
