              ...
              <div className="col-lg-6 col-md-6">
                ...
                >
                  <div className="product__details-content mb-40">
                    <h5 className="product-dtitle mb-20">Mobile App</h5>
                    <p>
                      Mobile Ordering
                      Made Easy!
                    </p>
                    ...
                    <div className="product-button">
                      <a href="https://documentorpos.com/app-info/" target="_blank" rel="noopener noreferrer">
                        <button className="tp-btn mr-20">Learn More</button>
                      </a>
                    </div>
                  </div>
                </div>
