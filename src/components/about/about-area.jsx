                            ...
                            >
                                <div className="tp-section">
                                    <h3 className="tp-section__title ab-title mb-25">
                                        We’ll Ensure You Always Get Best
                                        Solutions.
                                    </h3>
                                    <a
                                        className="tp-section__link"
                                        href="#nav-area"
                                    >
                                    ...
                                    <p className=" mr-20 mb-40">
                                        ...
                                        business market, Cygnus Payments found
                                        its passion; helping Small Business
                                        Owners (SBOs) grow their footprint and
                                        maximize their earnings through the
                                        latest, state-of-the-art FinTech
                                        solutions.
                                    </p>
                                </div>
