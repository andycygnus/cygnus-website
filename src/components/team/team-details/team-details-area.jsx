...
const team_info = [
    {
        ...
        des: (
            <>
                Providing insight-driven transformation to <br /> investment
                banks, wealth and asset mana, <br /> exchanges, Finance
            </>
        ),
            ...
            personal_info: [
                {
                    ...
                    des: (
                        <>
                            ...
                            <br />
                            account of the system, and sed expounds the <br />{' '}
                        ...
                        <div className="col-lg-12">
                            <div className="tp-team-dtls-text mt-40">
                                ...
                                <p>
                                    ...
                                    idea of denouncing works pleasure and
                                    praising uts pain was born and I will gives
                                    you a itself completed account of the
                                    system, and sed expounds the ut actual
                                    teachings of that greater sed explores
                                    truth. Denouncing works pleasures and
                                    praising pains was us born and I will gives
                                    you a completed ut workers accounts of the
                                    system. sit aspernatur aut odit aut fugit,
                                    sed quia consequuntur magni dolores eos qui
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6">
                            <div
                                ...
                                data-wow-delay=".2s"
                            >
                                <h4 className="tp-team-dtls-item__title mb-25">
                                    Skills
                                </h4>
                                <p>
                                    Must explain to you how all praising uts
                                    pain <br />
                                    was born and I will gives you a itself
                                    completed <br />
                                    account of the system, and sed expounds the{' '}
                                    <br /> ut actual teachings of that greater
                                </p>
