    ...
    <>
      <section className="services-area pt-120 pb-75">
        <div className="container">
          <div className="row align-items-end  mb-45">
            <div className="col-lg-5 col-md-12 col-12">
              <div className="tp-section">
                ...
                <h3 className="tp-section__title mb-30">POS System Solutions</h3>
              </div>
            </div>
            <div className="col-lg-7 col-md-12 col-12">
              <div className="services-link text-md-start text-lg-end mb-30">
                <span>
                  Well ensure you always get the best service:
                  <Link href="/contact">
          ...
          <h3 className="tp-section__title mb-30">Credit Card<br/>Terminals Solutions</h3>
          <div className="row">
